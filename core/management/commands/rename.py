...
class Command(BaseCommand):
    ...
    def handle(self, *args, **kwargs):
        ...
        files_to_rename = ['{DJANGO_PROJECT_BOILERPLATE}/settings.py',
                           '{DJANGO_PROJECT_BOILERPLATE}/wsgi.py', 'manage.py']
        folder_to_rename = '{ DJANGO_PROJECT_BOILERPLATE }'
        ...
        for f in files_to_rename:
            ...
            filedata = filedata.replace(
                '{ DJANGO_PROJECT_BOILERPLATE }', new_project_name)
